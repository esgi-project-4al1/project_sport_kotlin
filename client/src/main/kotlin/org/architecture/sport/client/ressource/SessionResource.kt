...
class SessionResource(
    ...
    fun joinSession(
        ...
        tryCatchUUID(sessionId) ?: return ResponseEntity.badRequest().body("Invalid UUID for sessionId")
        tryCatchUUID(userId) ?: return ResponseEntity.badRequest().body("Invalid UUID for userId")
